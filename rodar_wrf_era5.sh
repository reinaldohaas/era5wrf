...
export WORK_DIR="/home/jovyan/arquivos/era5"
export WPS_HOME="/home/jovyan/arquivos/WRF-Chem/WPS"
export WRF_HOME="/home/jovyan/arquivos/WRF-Chem/WRF"
export TEMPLATE_DIR="$WORK_DIR/template"


# --- CAMINHO DOS DADOS GEOGRÁFICOS ATUALIZADO ---
export GEOG_DATA_PATH="/home/jovyan/arquivos/gis4wrf/datasets/geog"
...
ln -sf /home/jovyan/arquivos/gis4wrf/datasets/geog/QNWFA_QNIFA_QNBCA_SIGMA_MONTHLY.dat .
...
echo ln -sf ${WPS_HOME}/geogrid .
ln -sf ${WPS_HOME}/geogrid .
echo ln -sf ${WPS_HOME}/metgrid .
ln -sf ${WPS_HOME}/metgrid .

# --- Configura o namelist.wps ---
echo cp -rf ${TEMPLATE_DIR}/namelist.wps .
